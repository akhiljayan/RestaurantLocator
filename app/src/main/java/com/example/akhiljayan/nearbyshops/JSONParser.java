...
public class JSONParser {
    ...
    static String readStream(InputStream is) {
        ...
        try {
            ...
            Log.e("readStream Exception", Log.getStackTraceString(e));
        }
        return(sb.toString());
    }
    ...
    public static String getStream(String url) {
        ...
        try {
            ...
            Log.e("getStream Exception", Log.getStackTraceString(e));
        } catch (Exception e) {
            Log.e("getStream Exception", Log.getStackTraceString(e));
        }
    ...
    public static String postStream(String url, String data) {
        ...
        try {
            ...
            Log.e("postStream Exception", Log.getStackTraceString(e));
        } catch (Exception e) {
            Log.e("postStream Exception", Log.getStackTraceString(e));
        }
        return readStream(is);
